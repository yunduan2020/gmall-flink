...
import com.tom.bean.OrderDetail;
import com.tom.bean.OrderInfo;
...
// (dwd-dim) -> FlinkApp(redis) -> Kafka(dwm)
// 程序：MockDb -> Mysql -> FlinkCDC -> kafka(ZK) -> BaseDbApp
// -> Kafka/Phoenix(zk/hdfs/hbase) -> OrderWideApp(Redis) -> Kafka
public class OrderWideApp {
    public static void main(String[] args) throws Exception {
        ...
        String groupId = "order_wide_group_2";
...
//        });
        ...
        // 打印测试
        // orderWideWithNoDimDS.print("orderWideWithUserDS");
