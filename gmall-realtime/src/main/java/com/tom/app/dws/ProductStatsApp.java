package com.tom.app.dws;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.tom.app.function.DimAsyncFunction;
import com.tom.bean.OrderWide;
import com.tom.bean.PaymentWide;
import com.tom.bean.ProductStats;
import com.tom.common.GmallConstant;
import com.tom.utils.ClickHouseUtil;
import com.tom.utils.DateTimeUtil;
...
public class ProductStatsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 6.分组、开窗、聚合   按照sku_id分组,10秒的滚动窗口,结合增量聚合(累加值)和全量聚合(提取窗口信息)
